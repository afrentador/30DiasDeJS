...
console.log(desafio.split(' '));
//R11:
let plataformas = 'Facebook, Google, Microsoft, Apple, IBM, Oracle, Amazon'
console.log(plataformas.split(', '));
//R12:
...
//R21:
console.log(desafio.startsWith('30 Dias'));
//R22:
console.log(desafio.endsWith('Script'));
//R23:
console.log(desafio.match(/a/g));
//R24:
let cadena = '30 Dias de '
console.log(cadena.concat('JavaScript'));
//R25:
